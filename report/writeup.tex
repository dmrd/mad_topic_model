...
\Procedure{MAD Generative Process}{}
 \State $T$ vocabularies, with $K_t$ topics. $D$ Documents, labelled into $A$ classes, with $T$ separate word counts for each of the $T$ vocabularies. assification parameter $\eta_t \in \mathbb{R}^n$
