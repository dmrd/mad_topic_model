...
typedef D1Array<uint32_t> IntArray;
...
typedef D1Array<std::tr1::unordered_set<uint32_t> *> SparseSet;
...
public:
    ...
    Env(uint32_t N, uint32_t M, uint32_t K, uint32_t K2, string fname,
...
inline
Env::Env(uint32_t N, uint32_t M, uint32_t K, uint32_t K2, string fname,
